...
CREATE TABLE online_course_manager (
  ...
  status int(11) NULL DEFAULT 200 COMMENT '管理者的状态（删除为404,正常为200, etc）',
...
CREATE TABLE online_course_admin (
  ...
  status int(11) NULL DEFAULT 200 COMMENT '后台人员的状态（删除为404,正常为200, etc）',
...
CREATE TABLE online_course_course (
  ...
  status int(11) NULL DEFAULT 200 COMMENT '课程的状态（删除为404,正常为200, etc）',
  extra_info varchar(300) NOT NULL DEFAULT '{}' COMMENT '一些额外信息',
  PRIMARY KEY (id)
) ENGINE=InnoDB;
...
CREATE TABLE online_course_subject (
  ...
  status int(11) DEFAULT 200 NULL COMMENT '课程的状态（删除为404,正常为200, etc）',
...
CREATE TABLE online_course_order (
  ...
  status int(11) NULL DEFAULT 200 COMMENT '订单的状态（删除为404,正常为200, etc）',
