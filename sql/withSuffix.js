module.exports = [
  ...
  },
  {
    ...
    create: `CREATE TABLE online_course_admin (
      id int NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
      admin_employee_no int NOT NULL COMMENT '后台人员工号',
      account varchar(50)  NOT NULL COMMENT '后台人员的账号',
      password varchar(16) NOT NULL COMMENT '后台人员密码',
      admin_phone varchar(11) NOT NULL COMMENT '后台人员的手机号',
      gmt_create_time varchar(20) NOT NULL COMMENT '后台人员创建时间<格林威治>(20180607)',
      admin_status int NULL DEFAULT 200 COMMENT '后台人员的状态（删除为404,正常为200, etc）',
